/**
   * Create By ☠︎︎𝐒𝚺𝐘--𝐍𝚵𝐓𝚰𝐗☠
   * Contact Me on 263776695904
*/
...
const initializeBot = async () => {
    ...
    console.log(chalk.green('   ☠︎︎𝐒𝚺𝐘--𝐍𝚵𝐓𝚰𝐗☠ 𝐩𝐚𝐢𝐫𝐢𝐧𝐠 𝐬𝐲𝐬𝐭𝐞𝐦       '));
    console.log(chalk.yellow('═══════════════════════════════════════════════\n'));

    autoLoadPairs().catch(err => console.error("Auto-load error:", err));
    launchBot();
};

function launchBot() {
    console.clear();
    console.log(chalk.green('🚀 Starting ☠︎︎𝐒𝚺𝐘--𝐍𝚵𝐓𝚰𝐗☠system...\n'));
    ...
    if (fs.existsSync(botPath)) {
        try {
            ...
            require('./bot');
            telegramLoaded = true;
            console.log(chalk.green('✅☠︎︎𝐒𝚺𝐘--𝐍𝚵𝐓𝚰𝐗☠bot loaded successfully!'));
        } catch (error) {
    ...
    console.log(chalk.bold.white('☠︎︎𝐒𝚺𝐘--𝐍𝚵𝐓𝚰𝐗☠BOT INITIALIZATION SUMMARY          '));
    console.log(chalk.cyan('═══════════════════════════════════════════════'));
    console.log(telegramLoaded ? chalk.green('✅☠︎︎𝐒𝚺𝐘--𝐍𝚵𝐓𝚰𝐗☠тɛℓɛɢяαм вσт: Active') : chalk.red('❌☠︎︎𝐒𝚺𝐘--𝐍𝚵𝐓𝚰𝐗☠тɛℓɛɢяαм вσт : Inactive'));
    ...
    if (!telegramLoaded && !whatsappLoaded) {
        ...
        console.log(chalk.green('✅ ☠︎︎𝐒𝚺𝐘--𝐍𝚵𝐓𝚰𝐗☠system is ready and running!\n'));
    }
